...
registry = Dict{String, ModelSpec}(
    ...
    "gemini-3-flash-preview" => ModelSpec("gemini-3-flash-preview",
        GoogleOpenAISchema(),
        0.5e-6,
        3e-6,
        "Gemini 3 Flash Preview is Google's fastest and most efficient model launched December 2025. 1M context, 65K output."),
